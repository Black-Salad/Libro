  ...
  return (
    <Paper className={classes.paper}>
      <div className={`${classes.topic} col-12`}>
        ...
        님이{"  "}
        <UserButton
          img={timeline.follow_id.target_user_id.user_img}
          name={timeline.follow_id.target_user_id.user_name}
          userId={timeline.follow_id.target_user_id.user_id}
        />
        님을 팔로우했습니다. 👬
