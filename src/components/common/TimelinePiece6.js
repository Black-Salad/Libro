  ...
  return (
    <Paper className={classes.paper}>
      <div className={`${classes.topic} col-12`}>
        ...
        님이{" "}
        <UserButton
          img={timeline.comment_id.note_id.user_id.user_img}
          name={timeline.comment_id.note_id.user_id.user_name}
          userId={timeline.comment_id.note_id.user_id.user_id}
        />
        님의{" "}
